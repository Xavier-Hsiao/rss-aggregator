...
func main() {
	...
	commands.Register("following", cli.MiddlewareLoggedIn(cli.HandlerGetFeedFollowsForUser))
	commands.Register("unfollow", cli.MiddlewareLoggedIn(cli.HandlerDeleteFeedFollowsForUser))
